      ...
      <div className="max-w-4xl mx-auto px-4 -mt-8 md:mt-12 grid grid-cols-1 md:grid-cols-3 gap-6">
        {[
          ...
          },
          {
            icon: Recycle,
            title: "Eco-Friendly",
            desc: "Contribute to environmental protection through responsible disposal."
          }
        ].map((feature, index) => (
          <div key={index} className="bg-white rounded-2xl shadow-lg p-6 border border-slate-100 hover:shadow-xl transition-shadow">
      ...
      <div className="max-w-4xl mx-auto px-4 mt-16 text-center">
        <div className="bg-slate-50 rounded-3xl p-8 border border-slate-200">
          ...
          <p className="text-slate-600 mb-6 max-w-2xl mx-auto">
            Join thousands of households who are already disposing of their pharmaceutical waste responsibly. Your small action can have a big impact.
          </p>
          <button 
            onClick={onStart}
